...
// nodemailer setup (for invitations)
// In prod, use a transactional provider
...
app.post('/api/families/:id/invite', authMiddleware, async (req, res) => {
  ...
  // check inviter rights: must be member
...
// Accept invite (either user exists and is logged in, or create account then accept)
...
// update & delete similar (omitted for brevity but easy to add)
